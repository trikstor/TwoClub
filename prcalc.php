...
<META name="keywords" lang="ru" content="Клуб Двоечников, проценты, процент, найти, вычислить, калькулятор">
<title>Найти процент | Клуб Двоечников</title>
...
<tr>
<td align=center>процент
<input type="text" name="a" size=5> 
% от числа<input type="text" name="b" size=5>?</td>
<td align=center>Ответ: <input type="text" name="total1" 
size=5 maxlength=40></td>
<td align=center><input type="button" value="Вычислить" 
onClick="calc1(this.form)"></td>
</tr>
<tr>
<td align=center colspan=3 align=center>Или...</td>
</tr>
<tr>
<td align=center>Какой процент число<input type="text" name="c" size=5>
от числа<input type="text" name="d" size=5>?</td>
<td align=center>Ответ: <input type="text" name="total2" 
size=5> %</td>
<td align=center><input type="button" value="Вычислить" 
