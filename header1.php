...
<table width="100%" border="0" cellpadding="0.1" style="text-decoration:none;">
  <tr>
    <td><img src="tests/mlogo.png" width="200px" /></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru">Главная</a></div></td>
    <td><div  id="button"><a id='bla' class="splLink" href="">Написать✎</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/glav.php" >Свежие вопросы</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/glav1.php" >Свежие статьи</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/studybook.php">Учебники</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/gdz.php">Решебники</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/calcs.php"  style="color:#FF8000;">Калькуляторы</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/tests/" style="color:#FF8000;">Тесты</a></div></td>
    <td><div  id="button"><a id='bla' href="http://math.twoclub.ru" style="color:#FF8000;">Формулы по математике </a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/upload.php" style="color:blue;">Облако☁</a></div></td>
    <td><div  id="button"><a id='bla' href="https://twoclub.ru/autorize.php">Войти в систему♕</a></div></td>
  </tr>
</table>
</menu>
</div>
<div class="splCont" style="margin-top:50px; color:white; height:50px; font-size:30px;">
<div align="center"> <a href="post.php"><b>Вопрос</b></a> | <a href="post1.php"><b>Статья</b></a> | <a href="tests.php"><b>Тест</b></a> </div>
</div>
</header>
...
<div style="margin:1%;"><img onclick="document.getElementById('tp1').style.display = 'none'" src="images/pop.gif" width="30px" /><a class="open_window" href="#"><img src="images/settings.gif" width="30px" /></a> </div>
...
<img  onclick="chrome.webstore.install()" src="images/ad102.png" width="100%" />
</div>
<br/>
...
<br/>
<br/>
<a class="button" href="http://math.twoclub.ru">Теория по математике</a><br/><br/>
...
<br/>
<br/>
<a class="button" href="random.php">Случайная</a><br/><br/>
...
<a href="rss.xml">
<div>
<img src="images/icoRss.gif" width=10%;/><br/>
