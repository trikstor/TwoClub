...
<META name="description" lang="ru" content="Все решебники, ГДЗ Клуба Двоечников - тут!">
<META name="keywords" lang="ru" content="Клуб Двоечников, ответы, ГДЗ, Решебник">
<title>ГДЗ | Клуб Двоечников</title>
...
<br/>
<div align="center">
<a href="ery.php" class="buttona black rectangular">Создать решебник</a>
<div align="center">
<form action="gdz.php" method="post">
...
$style = 'style="color:white; font-size:20px; padding:5px; background:grey; margin:3px; border-radius:3px; text-decoration: none;"';
...
$count = mysql_numrows(mysql_query('select * from gdz ORDER BY id DESC')) or die('error! Записей не найдено!');
...
$result = mysql_query('select * from gdz ORDER BY id DESC limit '.$start_pos.', '.$perpage) or die('error!');
while ($row = mysql_fetch_array($result)) {
		if(isset($_POST['predmet'])){
		if($row[5]==$_POST['predmet']){
echo "<a style='text-decoration:none;' href='".$row[3].".php '><div class='cob'><div style='margin-bottom:3px;'><b>".$row[0]."</b><img src='".$row[1]."' width='100'/>".$row[2]."<br/>Предмет:".$row[5]."</div></div></a><br/>";
		}
		}else{
echo "<a style='text-decoration:none;' href='".$row[3].".php '><div class='cob'><div style='margin-bottom:3px;'><b>".$row[0]."</b><img src='".$row[1]."' width='100'/>".$row[2]."<br/>Предмет:".$row[5]."</div></div></a><br/>";	
		}
